...
%eliminate crossover and write to NaN
...
% time_crossover=zeros(size(hsfp1));
% time_crossover1 = zeros(size(hsfp1));
% time_crossover2 = zeros(size(hsfp1));
% time_crossover3 = zeros(size(hsfp1));
