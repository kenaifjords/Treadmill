...
global F asym
i = 1;
colnames = {'subject','effortcondition','exposure','weight','addedmass',...
    'leglength','height','stridenumber','faststeplength','slowsteplength',...
    'faststeptime','slowsteptime','faststepwidth','slowstepwidth',...
    'maxstepnumber','peakbrake','peakpush','propimpulse'};


% colnames = {'subj' 'effortcondition' 'stepnumber' 'slasym' 'leglength' ...
%     'mass' 'addedmass' 'stasym' 'maxstepnumber' 'exposure' 'height'...
%     'fastleg', 'exposeinday','twovisitsubject','stepwidth'};
...
%             slasym = asym(subj).steplength{effcond,blk};
%             stasym = asym(subj).steptime{effcond,blk};
%             swasym = asym(subj).stepwidth{effcond,blk};
%             for istep = 1:length(slasym)
%                 % subj
%                 Rmat(i,1) = subj;
%                 % effort condition
...
writetable(labeled_Rmat,'Rmat_StepLTW.csv')
fprintf('mat made')
