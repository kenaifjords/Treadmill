...
%         end
        ...
        for blk = 1:length(subject.blockname)
            ...
            if size(dataraw,2) < 30
                ...
                disp(['INCOMPLETE CSV, NaNs added. Effort condition: ' num2str(effcond) ' block: ' num2str(blk)]);
            end
