...
%         plot(F{subj}.hsR{blk},p{subj}.Rankle{blk}(F{subj}.hsR_idx{blk},2),'r*');
%         plot(F{subj}.hsL{blk},p{subj}.Lankle{blk}(F{subj}.hsL_idx{blk},2),'b*');
%         plot(F{subj}.toR{blk},0,'ro');
%         plot(F{subj}.toL{blk},0,'bo');
...
%         hold off;
        ...
        plot(F{subj}.hsR{blk},p{subj}.Rankle{blk}(F{subj}.hsR_idx{blk},2),'r*');
        plot(F{subj}.hsL{blk},p{subj}.Lankle{blk}(F{subj}.hsL_idx{blk},2),'b*');
        plot(p{subj}.hsR{blk},p{subj}.Rankle{blk}(p{subj}.hsR_idx{blk},2),'m*');
        plot(p{subj}.hsL{blk},p{subj}.Lankle{blk}(p{subj}.hsL_idx{blk},2),'g*');
        plot(p{subj}.toR{blk},p{subj}.Rankle{blk}(p{subj}.toR_idx{blk},2),'mo');
        plot(p{subj}.toL{blk},p{subj}.Lankle{blk}(p{subj}.toL_idx{blk},2),'go');
        subplot(313);
        hold on;
        plot(p{subj}.trajtime{blk},p{subj}.limbangleR{blk},'r')
        plot(p{subj}.trajtime{blk},p{subj}.limbangleL{blk},'b')
        title('limb angle- this isnt working')
    end
end
toc